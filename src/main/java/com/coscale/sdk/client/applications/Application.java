...
public class Application {
    ...
    @Nullable
    public String state; //(string, optional): The state of the app (ENABLED, INACTIVE, DISABLED). ,
    ...
    public Application(Long id, Long version, String name, String appId, Long ownerId, String state, boolean invoiceYearly, Long startType, Long endTimeFreeTrial, Long planId) {
        this.id = id;
